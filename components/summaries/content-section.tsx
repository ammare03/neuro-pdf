...
const EmojiPoint = ({ point }: { point: string }) => {
  ...
  return (
    <div className="group relative bg-linear-tobr from-gray-200/[0.08] to-gray-400/[0.03] p-4 rounded-2xl border border-gray-500/10 hover:shadow-lg transition-all">
